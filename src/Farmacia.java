...
/**
 * 
 * Representação de uma farmacia que possui coleção de clientes, funcionarios,
 * produtos e pedidos.
 *
 * 
 */
public final class Farmacia {
	...
	/**
	 * Este método adiciona um novo produto a ser negociado na farmacia. Esse novo
	 * produto precisa ser um produto válido.
	 *
	 * @param novoProduto Produto a ser cadastrado na farmácia.
	 */
	 ...
	 *
	 * @param novoCliente o cliente a ser adicionado ao sistema
	 */
	...
	/**
	 * Este método adiciona um novo funcionario no sistema da farmacia. Esse novo
	 * funcionario precisa ser um funcionario válido.
	 *
	 * @param novoFuncionario o funcionario a ser adicionado no sistema
	 */
	...
	/**
	 * Este método adiciona um novo pedido a um cliente já cadastrado no sistema da
	 * farmacia. Esse novo pedido precisa ser um pedido válido, assim como a
	 * identificador do cliente relacionado ao pedido.
	 *
	 * @param novoPedido o pedido a ser adicionado ao cliente já cadastrado
	 */
	 ...
	 *
	 * @param idPedido Id do pedido especefico.
